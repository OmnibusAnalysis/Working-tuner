  ...
  return (
    <main className="min-h-screen flex flex-col items-center bg-zinc-900 pt-24 pb-12 px-4">
      <div className="max-w-md w-full">
        <header>
          <h1 className="text-3xl font-bold text-center mb-2 text-zinc-100">Working Tuner</h1>
          <p className="text-center mb-8 text-zinc-400">Guitar, Bass, Ukulele, Banjo & Mandolin</p>
        </header>
        
        <section aria-label="Tuner Application">
          <Tuner />
        ...
        <section className="mt-8 text-center">
          <article>
            <header>
              <h2 className="text-xl font-semibold text-zinc-200 mb-2">About Working Tuner</h2>
            </header>
            <p className="text-zinc-400 text-sm mb-4">
              Working Tuner is a free online instrument tuner that supports guitar, bass, ukulele, banjo, and mandolin. It
          ...
          <aside className="mt-8 border-t border-zinc-800 pt-6">
